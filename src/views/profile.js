    ...
    <div className="profile-container">
      ...
      <div className="profile-profile">
        <Header
          text={
            <Fragment>
              <span className="profile-text">Awareness</span>
            </Fragment>
          }
        ...
        <div className="profile-container01">
          <div className="profile-container02">
            <h4 className="profile-text01">Michael Roven</h4>
            <OutlineBlueButton button="follow"></OutlineBlueButton>
          </div>
          <div className="profile-container03">
            <span className="profile-text02">
              <span className="profile-text03">323</span>
              <span> Posts</span>
            </span>
            <span className="profile-text05">
              <span className="profile-text06">3.5k</span>
              <span> Followers</span>
            </span>
            <span>
              <span className="profile-text09">260</span>
              <span> Following</span>
            </span>
          </div>
      ...
      <div className="profile-blog-posts">
        <h1 className="profile-text12">
          <span>Active Projects:</span>
          <br className="HeadingTwo"></br>
        </h1>
          ...
          <div className="profile-container05">
            <div className="profile-card">
              <div className="profile-container06">
                <h1 className="profile-text15">Flexible work hours</h1>
                ...
                <div className="profile-container07">
                  <button className="profile-button button">
                    <span className="profile-text18">Read more</span>
      ...
      <div className="profile-contact">
        <div className="profile-container09">
          <div className="profile-form">
            <h2 className="profile-text19 HeadingOne">
              <span>Say Hi!</span>
            </h2>
            <span className="profile-text21 Lead">
              I&apos;d like to talk with you.
            </span>
            <form className="profile-form1">
              <label className="profile-text22 Label">My name is</label>
              <input
                type="text"
              ...
              />
              <label className="profile-text24 Label">Your message</label>
              <textarea
                rows="8"
            ...
            <div className="profile-container12">
              ...
              <div className="profile-container13">
                ...
                <div className="profile-container16">
                  ...
                  <span className="profile-text29 Small">
